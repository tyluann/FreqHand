...
class EfficientNet(nn.Module):
    ...
    def extract_features(self, inputs):
        ...
        # Stem
        x = self._swish(self._bn0(self._conv_stem(inputs)))#[B,40,112,112]
        #import pdb; pdb.set_trace()
        # Blocks
    ...
    def forward(self, inputs):
        ...
        bs = inputs.size(0)
        # Convolution layers
        x, y, low, mid, high = self.extract_features(inputs)#
