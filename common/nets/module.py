...
class BackboneNet(nn.Module):
    def __init__(self):
        ...
        self.resnet = ResNetBackbone(cfg.cfg.resnet_type)
        self.fc = make_linear_layers([2048,cfg.cfg.backbone_img_feat_dim])
...
class PoseNet(nn.Module):
    def __init__(self, skeleton):
        ...
        self.fc = make_linear_layers([cfg.cfg.backbone_img_feat_dim,512,self.dof_num], relu_final=False)
...
class SkeletonRefineNet(nn.Module):
    def __init__(self, skeleton):
        ...
        self.joint_num = len(skeleton)
        self.fc_skeleton = make_linear_layers([cfg.cfg.id_code_dim,64,self.joint_num*3], relu_final=False)
...
class SkinRefineNet(nn.Module):
    def __init__(self, skeleton, vertex_num):
        ...
        self.fc_id = make_linear_layers([cfg.cfg.id_code_dim,256,vertex_num*3], relu_final=False)
